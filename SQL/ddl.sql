...
DROP SEQUENCE GS_USUARIO_SEQ;

DROP SEQUENCE GS_VEICULO_SEQ;

DROP SEQUENCE GS_POSTO_CARREGAMENTO_SEQ;

DROP SEQUENCE GS_PONTO_CARREGAMENTO_SEQ;

DROP SEQUENCE GS_RESERVA_SEQ;

DROP SEQUENCE GS_HISTORICO_CARREGAMENTO_SEQ;

DROP SEQUENCE GS_AVALIACAO_SEQ;

DROP SEQUENCE GS_VIAGEM_SEQ;

DROP SEQUENCE GS_PONTO_PARADA_SEQ;
